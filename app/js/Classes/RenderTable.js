...
class RenderTable {
  ...
  #renderDate(record, tr) {
    ...
    div.innerHTML = `Created At: ${record['created_at']}`;
    td.appendChild(div);
    tr.appendChild(td);
    
    div = document.createElement('div');
    div.innerHTML = `Updated At: ${record['updated_at']}`;
    td.appendChild(div);
    tr.appendChild(td);
  }

  #renderLink(record, tr) {
    let td = document.createElement('td');
    ...
    a.href = `/summary_wms/controllers[...]/action/${record['id']}`;
    td.appendChild(a);
    tr.appendChild(td);
